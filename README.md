...
# 2. Directory — verify & check (400 APIs, ~85s)
...
Current: **395/400 Live (98.8%)** — see `packages/directory/data/results.json:3`, sparkline from `history-summary.json:1`, drift from `drift-report.json:1`.
